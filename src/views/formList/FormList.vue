...
.form-list-page {
  ...
  &.dark-theme {
    ...
    div {
      &:not(.el-table__cell):not(.el-form-item):not(.el-dialog__body):not(.el-dialog__footer):not(.el-collapse-item__content):not(.el-tree-node__content):not(.el-time-spinner__item):not(.el-date-table__cell):not(.el-select-dropdown__item):not(.el-checkbox__input) {
